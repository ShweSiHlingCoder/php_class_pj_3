<section id="testimonials" class="testimonials">
   <div class="container" data-aos="fade-up">
    ...
    <div class="section-header">
     <h2>Testimonials</h2>
     <p>Voluptatem quibusdam ut ullam perferendis repellat non ut consequuntur est eveniet deleniti fignissimos eos quam
     </p>
    </div>
       ...
       <div class="testimonial-wrap">
        <div class="testimonial-item">
         ...
         <p>
          ...
          duis sunt culpa nulla illum cillum fugiat legam esse veniam culpa fore.
          <i class="bi bi-quote quote-icon-right"></i>
         </p>
        </div>
       </div>
